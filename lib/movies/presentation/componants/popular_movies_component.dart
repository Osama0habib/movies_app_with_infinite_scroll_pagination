      ...
      builder: (context, state) {
        switch(state.popularMoviesRequestState){
                    ...
                    return Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  MovieDetailScreen(id: state.popularMovies[index].id,)));
                        },
                        child: ClipRRect(
                          borderRadius:
          ...
          case RequestState.error:
            return  SizedBox(height: 400,child: Center(child: Text(state.popularMoviesMessage),),);
        }
