      ...
      builder: (context, state) {
        switch(state.topRatedMoviesRequestState){
                    ...
                    return Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  MovieDetailScreen(id: state.topRatedMovies[index].id,)));
          ...
          case RequestState.error:
            return  SizedBox(height: 400,child: Center(child: Text(state.topRatedMoviesMessage),),);
        }
