      ...
      builder: (context, state) {
        switch(state.nowPlayingMoviesRequestState){
              ...
              child: CarouselSlider(
                ...
                items: state.nowPlayingMovies.map(
                    ...
                    return GestureDetector(
                      ...
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  MovieDetailScreen(id: item.id,)));
          ...
          case RequestState.error:
            return  SizedBox(height: 400,child: Center(child: Text(state.nowPlayingMoviesMessage),),);
        }
